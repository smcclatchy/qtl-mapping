...
This linear model is $y$ = `r round(c2eff[max_mkr,4], 1)` + `r round(abs(c2eff[max_mkr,1]), 1)`$G + \epsilon$. The model intersects the 
...
`r subset(peaks, chr == '2')$pos` Mb. We can pass this value into the `qtl2` 
