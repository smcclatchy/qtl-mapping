...
below, &mu; equals `r round(c2eff[max_mkr, 4], 1)`, and &beta; equals 
`r round(abs(c2eff[max_mkr, 1]), 1)` for the alternative hypothesis 
(QTL exists).
...
`r round(c2eff[max_mkr,2], 1)` relative to &mu; equals 
...
For example, we could get inferred genotypes at the chromosome 7 QTL for the 
