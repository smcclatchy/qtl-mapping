...
different methods for QTL analysis. We discuss two of these methods here.  
...
The example illustrated below uses data from an experiment on hypertension in 
the mouse 
...
possible genotypes - AA for homozygotes, and AB for heterozygotes. It is much
simpler to illustrate Haley-Knott regression with a backcross than with an
intercross.
