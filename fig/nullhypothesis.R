...
png(filename = "fig/nullhypothesis.png", width = 600, height = 600)
par(mai = c(1, 1, 1, 1.5))
...
segments(x0 = 3, y0 = mu, y1 = 155,
         lwd=2, lty = 1)
segments(x0 = 2.25, y0 = mu, y1 = 155,
         lwd=2, lty = 1)
segments(x0 = 2.25, y0 = mu, x1 = 3,
         lwd=2, lty = 1)
segments(x0 = 2.25, y0 = 155, x1 = 3,
         lwd=2, lty = 1)
